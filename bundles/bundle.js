...
var getEnumerableProperties = __webpack_require__(48);
var config = __webpack_require__(4);
...
(function (SampleLoader) {
    ...
    function createCard(recipe) {
        let c = CardCreator_1.CardCreator.parse(recipe.name + "\n" + recipe.card);
...
class Card {
    ...
    static createBear() {
        ...
        c.power = 2;
        c.toughness = 2;
        c.typeline = Typeline_1.Typeline.creature(CreatureSubtype_1.CreatureSubtype.Bear);
        c.abilities = [];
        c.color = [Typeline_1.Color.Green];
        return c;
    }
    static createArtifact() {
        ...
        c.name = "Thing";
        c.typeline = new Typeline_1.Typeline();
        c.typeline.types.push(Typeline_1.Type.Artifact);
        c.abilities = [];
        c.color = [];
        return c;
    }
...
const NamedAbilities_1 = __webpack_require__(37);
class AbilityCreator {
    ...
    parseScript(script) {
        ...
        if (script.trim() == "changeling") {
            ...
            this.ability.effect.modification.parts.push(new Modification_1.ChangelingModification());
            return;
        }
    ...
    parseLine(line) {
        ...
        if (["flying", "first strike", "haste"].includes(line)) {
            ...
            this.effect.modification.parts.push(new Modification_1.SwitchPTModification());
        }
            ...
            this.effect.modification.parts.push(new Modification_1.SetColorToModification(Typeline_1.stringToColor(line.substr("setcolor:".length))));
        }
        else if (line.startsWith("addcolor:")) {
            this.effect.modification.parts.push(new Modification_1.AddColorModification(Typeline_1.stringToColor(line.substr("addcolor:".length))));
        }
        else if (line.startsWith("setpt:")) {
            let [power, toughness] = Utilities_1.parsePT(line.substr("setpt:".length));
            this.effect.modification.parts.push(new Modification_1.SetPowerToughnessModification(power, toughness));
        }
        else if (line.startsWith("addtype:")) {
            this.effect.modification.parts.push(new Modification_1.AddTypeModification(Typeline_1.stringToType(line.substr("addtype:".length))));
        }
            ...
            this.effect.modification.parts.push(new Modification_1.AddAbilityModification(parseAsAbility(innerAbility)));
        }
        else if (line == "silence") {
            this.effect.modification.parts.push(new Modification_2.SilenceModification());
        }
        else if (line == "losecolors") {
            this.effect.modification.parts.push(new Modification_1.LoseColorsModification());
        }
        else if (line.startsWith("namedability:")) {
            this.effect.modification.parts.push(new Modification_1.AddAbilityModification(NamedAbilities_1.NamedAbilities.create(line.substr("namedability:".length))));
        }
        else {
...
class Modification {
    ...
    addPTModification(power, toughness) {
        this.parts.push(new Modification_1.PowerToughnessModification(power, toughness));
    }
    addGrantPrimitiveAbility(ab) {
        this.parts.push(new Modification_1.AddAbilityModification(ab));
    }
...
const EnumEx_1 = __webpack_require__(21);
const CreatureSubtype_1 = __webpack_require__(6);
const SingleModificationBase_1 = __webpack_require__(23);
...
Object.defineProperty(exports, "__esModule", { value: true });
const DependencySort_1 = __webpack_require__(38);
const Layer_1 = __webpack_require__(7);
class StateCheck {
    get effects() {
...
const AbilityCreation_1 = __webpack_require__(16);
const CardCreator_1 = __webpack_require__(13);
const Examples_1 = __webpack_require__(39);
const Permanent_1 = __webpack_require__(15);
const ScenarioLoader_1 = __webpack_require__(40);
...
angular.module('PrimaryApp', [])
    ...
    $scope.battlefield = [];
    $scope.hand = [Card_1.Card.createBear()];
    mainscope = $scope;
    ...
    $scope.createExample = (id) => {
        Examples_1.Examples.createExample(id, $scope.battlefield, $scope.hand);
        reevaluateValues();
    };
    ...
    $scope.cardCreatorCreate = function () {
        $scope.hand.push(CardCreator_1.CardCreator.parse($scope.cardCreatorScript));
    };
    $scope.drawArtifact = function () {
        $scope.hand.push(Card_1.Card.createArtifact());
        reevaluateValues();
    };
    $scope.drawBear = function () {
        $scope.hand.push(Card_1.Card.createBear());
        reevaluateValues();
    };
...
class DependencySort {
   ...
   */
    ...
    static dependsOn(mainEffect, dependsOnThis, stateCheck, layer) {
        ...
        let stateCheckCopy = DependencySort.createdCopiedLinkedBattlefield(stateCheck);
    ...
    static createdCopiedLinkedBattlefield(battlefield) {
        // TODO do this
        let sc = new StateCheck_1.StateCheck([], []);
        return sc;
    }
}
...
(function (Examples) {
    function form(...lines) {
        return AbilityCreation_1.parseAsAbility(lines.join("\n"));
    }
    function join(...lines) {
        return lines.join("\n");
    }
    function createExample(identifier, battlefield, hand) {
        ...
        switch (identifier) {
            ...
            case "613.3e2":
                ...
                c.abilities.push(form('this', 'gets', 'switch'));
                p = Permanent_1.Permanent.fromCard(c);
                c2 = CardCreator_1.CardCreator.parse("Defensive Booster\nartifact");
                c2.abilities.push(form('creatures', 'get', '+0/+1'));
                let p2 = Permanent_1.Permanent.fromCard(c2);
                battlefield.push(p2);
                battlefield.push(p);
                break;
            case "613.3e3":
                ...
                {
                    let c = CardCreator_1.CardCreator.parse("Spider\n1/3 green Spider creature");
                    battlefield.push(Permanent_1.Permanent.fromCard(c));
                    let a1 = CardCreator_1.CardCreator.parse("Defensive Booster\nartifact");
                    a1.abilities.push(form('creatures', 'get', '+0/+1'));
                    battlefield.push(Permanent_1.Permanent.fromCard(a1));
                    let a2 = CardCreator_1.CardCreator.parse("Switcher\nartifact");
                    a2.abilities.push(form('creatures', 'get', 'switch'));
                    battlefield.push(Permanent_1.Permanent.fromCard(a2));
                    battlefield.push(Permanent_1.Permanent.fromCard(a2));
                }
                break;
            case "613.8.1":
                ...
                {
                    let c = Card_1.Card.createBear();
                    let a1 = Card_1.Card.createArtifact();
                    let a2 = Card_1.Card.createArtifact();
            ...
            case "613.4e1":
                {
                    ...
                    let c = CardCreator_1.CardCreator.parse("Honor of the Pure\nwhite enchantment");
                    c.abilities.push(form('white creatures youcontrol', 'get', '+1/+1'));
                    battlefield.push(c.asPermanent());
                    battlefield.push(Card_1.Card.createBear().asPermanent());
                    let d = Card_1.Card.createArtifact();
                    d.abilities.push(form('bear', 'get', 'setcolor:white'));
                    battlefield.push(d.asPermanent());
                    let e = Card_1.Card.createArtifact();
            ...
            case "613.4e2":
                {
                    ...
                    let p = Card_1.Card.createBear().asPermanent();
                    battlefield.push(p);
                    p.counters.push(new Card_1.Counter(1, 1));
                    let a = Card_1.Card.createArtifact();
                    a.abilities.push(form('bear', 'get', '+4/+4'));
                    let b = Card_1.Card.createArtifact();
                    b.abilities.push(form('bear', 'get', '+0/+2'));
                    let c = Card_1.Card.createArtifact();
            ...
            case "613.5e1":
                {
                    ...
                    let p = CardCreator_1.CardCreator.parse("Wild Mongrel\n2/2 green creature");
...
*/
                {
                    battlefield.push(Card_1.Card.createArtifact().asPermanent());
                    let c = CardCreator_1.CardCreator.parse("Little March\nblue enchantment");
...
*/
                {
                    let svogthos = SampleLoader_1.SampleLoader.createCard({
                        name: "Svogthos, the Restless Tomb",
                        card: "land",
                        abilities: []
                    });
                    let animation = Card_1.Card.createArtifact();
                    animation.abilities.push(form("lands youcontrol", "gain", "setpt:3/3", "addtype:creature"));
                    let anthem = SampleLoader_1.SampleLoader.createCard({
                        name: "Glorious Anthem",
                        card: "white enchantment",
                        abilities: [["creatures youcontrol", "get", "+1/+1"]]
                    });
                    let svogthosAbility = SampleLoader_1.SampleLoader.createCard({
    ...
    Examples.createExample = createExample;
...
Object.defineProperty(exports, "__esModule", { value: true });
const Scenarios_1 = __webpack_require__(41);
...
const Typeline_1 = __webpack_require__(1);
const CreatureSubtype_1 = __webpack_require__(6);
const OrderOfOperationsScenarios_1 = __webpack_require__(65);
exports.Scenarios = [
...
var pathval = __webpack_require__(43);
...
exports.compareByInspect = __webpack_require__(56);
...
exports.getOwnEnumerableProperties = __webpack_require__(57);

/*!
 * Checks error against a given set of criteria
 */

exports.checkError = __webpack_require__(58);
...
exports.addLengthGuard = __webpack_require__(10);

/*!
 * isProxyEnabled helper
 */

exports.isProxyEnabled = __webpack_require__(9);

/*!
 * isNaN method
 */

exports.isNaN = __webpack_require__(59);
...
var addLengthGuard = __webpack_require__(10);
var chai = __webpack_require__(3);
var flag = __webpack_require__(0);
