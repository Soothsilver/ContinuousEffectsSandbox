...
(function (Type) {
    ...
    Type[Type["Enchantment"] = 1] = "Enchantment";
    Type[Type["Creature"] = 2] = "Creature";
    Type[Type["Land"] = 3] = "Land";
})(Type = exports.Type || (exports.Type = {}));
function stringToType(word) {
    switch (word) {
...
function stringToSubtype(word) {
    for (let s of EnumEx_1.EnumEx.getValues(CreatureSubtype_1.CreatureSubtype)) {
        if (word.toLowerCase() == CreatureSubtype_1.CreatureSubtype[s].toLowerCase()) {
            return s;
        }
    }
    return null;
}
exports.stringToSubtype = stringToSubtype;
var ArtifactSubtype;
(function (ArtifactSubtype) {
...
function joinAnyList(pole) {
    if (pole.length == 0)
        return "";
    if (pole.length == 1)
        return pole[0].toString();
    let s = "";
    for (let i = 0; i < pole.length - 2; i++) {
        s += pole[i].toString() + ", ";
    }
...
exports.joinAnyList = joinAnyList;
function parsePT(line) {
    if (line.indexOf('/') == -1) {
        return [NaN, NaN];
    }
...
function getCssColor(color) {
    if (color.length == 0) {
        ...
        switch (color[0]) {
            case Typeline_1.Color.Black: return "black";
            case Typeline_1.Color.Blue: return "blue";
            case Typeline_1.Color.Green: return "green";
            case Typeline_1.Color.Red: return "red";
            case Typeline_1.Color.White: return "white";
        }
    }
    else {
        return "gold";
...
(function (CreatureSubtype) {
    ...
    CreatureSubtype[CreatureSubtype["Aetherborn"] = 1] = "Aetherborn";
    CreatureSubtype[CreatureSubtype["Ally"] = 2] = "Ally";
    CreatureSubtype[CreatureSubtype["Angel"] = 3] = "Angel";
    CreatureSubtype[CreatureSubtype["Antelope"] = 4] = "Antelope";
    CreatureSubtype[CreatureSubtype["Ape"] = 5] = "Ape";
    CreatureSubtype[CreatureSubtype["Archer"] = 6] = "Archer";
    CreatureSubtype[CreatureSubtype["Archon"] = 7] = "Archon";
    CreatureSubtype[CreatureSubtype["Artificer"] = 8] = "Artificer";
    CreatureSubtype[CreatureSubtype["Assassin"] = 9] = "Assassin";
    CreatureSubtype[CreatureSubtype["AssemblyWorker"] = 10] = "AssemblyWorker";
    CreatureSubtype[CreatureSubtype["Atog"] = 11] = "Atog";
    CreatureSubtype[CreatureSubtype["Aurochs"] = 12] = "Aurochs";
    CreatureSubtype[CreatureSubtype["Avatar"] = 13] = "Avatar";
    CreatureSubtype[CreatureSubtype["Badger"] = 14] = "Badger";
    CreatureSubtype[CreatureSubtype["Barbarian"] = 15] = "Barbarian";
    CreatureSubtype[CreatureSubtype["Basilisk"] = 16] = "Basilisk";
    CreatureSubtype[CreatureSubtype["Bat"] = 17] = "Bat";
    CreatureSubtype[CreatureSubtype["Bear"] = 18] = "Bear";
    CreatureSubtype[CreatureSubtype["Beast"] = 19] = "Beast";
    CreatureSubtype[CreatureSubtype["Beeble"] = 20] = "Beeble";
    CreatureSubtype[CreatureSubtype["Berserker"] = 21] = "Berserker";
    CreatureSubtype[CreatureSubtype["Bird"] = 22] = "Bird";
    CreatureSubtype[CreatureSubtype["Blinkmoth"] = 23] = "Blinkmoth";
    CreatureSubtype[CreatureSubtype["Boar"] = 24] = "Boar";
    CreatureSubtype[CreatureSubtype["Bringer"] = 25] = "Bringer";
    CreatureSubtype[CreatureSubtype["Brushwagg"] = 26] = "Brushwagg";
    CreatureSubtype[CreatureSubtype["Camarid"] = 27] = "Camarid";
    CreatureSubtype[CreatureSubtype["Camel"] = 28] = "Camel";
    CreatureSubtype[CreatureSubtype["Caribou"] = 29] = "Caribou";
    CreatureSubtype[CreatureSubtype["Carrier"] = 30] = "Carrier";
    CreatureSubtype[CreatureSubtype["Cat"] = 31] = "Cat";
    CreatureSubtype[CreatureSubtype["Centaur"] = 32] = "Centaur";
    CreatureSubtype[CreatureSubtype["Cephalid"] = 33] = "Cephalid";
    CreatureSubtype[CreatureSubtype["Chimera"] = 34] = "Chimera";
    CreatureSubtype[CreatureSubtype["Citizen"] = 35] = "Citizen";
    CreatureSubtype[CreatureSubtype["Cleric"] = 36] = "Cleric";
    CreatureSubtype[CreatureSubtype["Cockatrice"] = 37] = "Cockatrice";
    CreatureSubtype[CreatureSubtype["Construct"] = 38] = "Construct";
    CreatureSubtype[CreatureSubtype["Coward"] = 39] = "Coward";
    CreatureSubtype[CreatureSubtype["Crab"] = 40] = "Crab";
    CreatureSubtype[CreatureSubtype["Crocodile"] = 41] = "Crocodile";
    CreatureSubtype[CreatureSubtype["Cyclops"] = 42] = "Cyclops";
    CreatureSubtype[CreatureSubtype["Dauthi"] = 43] = "Dauthi";
    CreatureSubtype[CreatureSubtype["Demon"] = 44] = "Demon";
    CreatureSubtype[CreatureSubtype["Deserter"] = 45] = "Deserter";
    CreatureSubtype[CreatureSubtype["Devil"] = 46] = "Devil";
    CreatureSubtype[CreatureSubtype["Dinosaur"] = 47] = "Dinosaur";
    CreatureSubtype[CreatureSubtype["Djinn"] = 48] = "Djinn";
    CreatureSubtype[CreatureSubtype["Dragon"] = 49] = "Dragon";
    CreatureSubtype[CreatureSubtype["Drake"] = 50] = "Drake";
    CreatureSubtype[CreatureSubtype["Dreadnought"] = 51] = "Dreadnought";
    CreatureSubtype[CreatureSubtype["Drone"] = 52] = "Drone";
    CreatureSubtype[CreatureSubtype["Druid"] = 53] = "Druid";
    CreatureSubtype[CreatureSubtype["Dryad"] = 54] = "Dryad";
    CreatureSubtype[CreatureSubtype["Dwarf"] = 55] = "Dwarf";
    CreatureSubtype[CreatureSubtype["Efreet"] = 56] = "Efreet";
    CreatureSubtype[CreatureSubtype["Elder"] = 57] = "Elder";
    CreatureSubtype[CreatureSubtype["Eldrazi"] = 58] = "Eldrazi";
    CreatureSubtype[CreatureSubtype["Elemental"] = 59] = "Elemental";
    CreatureSubtype[CreatureSubtype["Elephant"] = 60] = "Elephant";
    CreatureSubtype[CreatureSubtype["Elf"] = 61] = "Elf";
    CreatureSubtype[CreatureSubtype["Elk"] = 62] = "Elk";
    CreatureSubtype[CreatureSubtype["Eye"] = 63] = "Eye";
    CreatureSubtype[CreatureSubtype["Faerie"] = 64] = "Faerie";
    CreatureSubtype[CreatureSubtype["Ferret"] = 65] = "Ferret";
    CreatureSubtype[CreatureSubtype["Fish"] = 66] = "Fish";
    CreatureSubtype[CreatureSubtype["Flagbearer"] = 67] = "Flagbearer";
    CreatureSubtype[CreatureSubtype["Fox"] = 68] = "Fox";
    CreatureSubtype[CreatureSubtype["Frog"] = 69] = "Frog";
    CreatureSubtype[CreatureSubtype["Fungus"] = 70] = "Fungus";
    CreatureSubtype[CreatureSubtype["Gargoyle"] = 71] = "Gargoyle";
    CreatureSubtype[CreatureSubtype["Germ"] = 72] = "Germ";
    CreatureSubtype[CreatureSubtype["Giant"] = 73] = "Giant";
    CreatureSubtype[CreatureSubtype["Gnome"] = 74] = "Gnome";
    CreatureSubtype[CreatureSubtype["Goat"] = 75] = "Goat";
    CreatureSubtype[CreatureSubtype["Goblin"] = 76] = "Goblin";
    CreatureSubtype[CreatureSubtype["God"] = 77] = "God";
    CreatureSubtype[CreatureSubtype["Golem"] = 78] = "Golem";
    CreatureSubtype[CreatureSubtype["Gorgon"] = 79] = "Gorgon";
    CreatureSubtype[CreatureSubtype["Graveborn"] = 80] = "Graveborn";
    CreatureSubtype[CreatureSubtype["Gremlin"] = 81] = "Gremlin";
    CreatureSubtype[CreatureSubtype["Griffin"] = 82] = "Griffin";
    CreatureSubtype[CreatureSubtype["Hag"] = 83] = "Hag";
    CreatureSubtype[CreatureSubtype["Harpy"] = 84] = "Harpy";
    CreatureSubtype[CreatureSubtype["Hellion"] = 85] = "Hellion";
    CreatureSubtype[CreatureSubtype["Hippo"] = 86] = "Hippo";
    CreatureSubtype[CreatureSubtype["Hippogriff"] = 87] = "Hippogriff";
    CreatureSubtype[CreatureSubtype["Homarid"] = 88] = "Homarid";
    CreatureSubtype[CreatureSubtype["Homunculus"] = 89] = "Homunculus";
    CreatureSubtype[CreatureSubtype["Horror"] = 90] = "Horror";
    CreatureSubtype[CreatureSubtype["Horse"] = 91] = "Horse";
    CreatureSubtype[CreatureSubtype["Hound"] = 92] = "Hound";
    CreatureSubtype[CreatureSubtype["Human"] = 93] = "Human";
    CreatureSubtype[CreatureSubtype["Hydra"] = 94] = "Hydra";
    CreatureSubtype[CreatureSubtype["Hyena"] = 95] = "Hyena";
    CreatureSubtype[CreatureSubtype["Illusion"] = 96] = "Illusion";
    CreatureSubtype[CreatureSubtype["Imp"] = 97] = "Imp";
    CreatureSubtype[CreatureSubtype["Incarnation"] = 98] = "Incarnation";
    CreatureSubtype[CreatureSubtype["Insect"] = 99] = "Insect";
    CreatureSubtype[CreatureSubtype["Jackal"] = 100] = "Jackal";
    CreatureSubtype[CreatureSubtype["Jellyfish"] = 101] = "Jellyfish";
    CreatureSubtype[CreatureSubtype["Juggernaut"] = 102] = "Juggernaut";
    CreatureSubtype[CreatureSubtype["Kavu"] = 103] = "Kavu";
    CreatureSubtype[CreatureSubtype["Kirin"] = 104] = "Kirin";
    CreatureSubtype[CreatureSubtype["Kithkin"] = 105] = "Kithkin";
    CreatureSubtype[CreatureSubtype["Knight"] = 106] = "Knight";
    CreatureSubtype[CreatureSubtype["Kobold"] = 107] = "Kobold";
    CreatureSubtype[CreatureSubtype["Kor"] = 108] = "Kor";
    CreatureSubtype[CreatureSubtype["Kraken"] = 109] = "Kraken";
    CreatureSubtype[CreatureSubtype["Lamia"] = 110] = "Lamia";
    CreatureSubtype[CreatureSubtype["Lammasu"] = 111] = "Lammasu";
    CreatureSubtype[CreatureSubtype["Leech"] = 112] = "Leech";
    CreatureSubtype[CreatureSubtype["Leviathan"] = 113] = "Leviathan";
    CreatureSubtype[CreatureSubtype["Lhurgoyf"] = 114] = "Lhurgoyf";
    CreatureSubtype[CreatureSubtype["Licid"] = 115] = "Licid";
    CreatureSubtype[CreatureSubtype["Lizard"] = 116] = "Lizard";
    CreatureSubtype[CreatureSubtype["Manticore"] = 117] = "Manticore";
    CreatureSubtype[CreatureSubtype["Masticore"] = 118] = "Masticore";
    CreatureSubtype[CreatureSubtype["Mercenary"] = 119] = "Mercenary";
    CreatureSubtype[CreatureSubtype["Merfolk"] = 120] = "Merfolk";
    CreatureSubtype[CreatureSubtype["Metathran"] = 121] = "Metathran";
    CreatureSubtype[CreatureSubtype["Minion"] = 122] = "Minion";
    CreatureSubtype[CreatureSubtype["Minotaur"] = 123] = "Minotaur";
    CreatureSubtype[CreatureSubtype["Mole"] = 124] = "Mole";
    CreatureSubtype[CreatureSubtype["Monger"] = 125] = "Monger";
    CreatureSubtype[CreatureSubtype["Mongoose"] = 126] = "Mongoose";
    CreatureSubtype[CreatureSubtype["Monk"] = 127] = "Monk";
    CreatureSubtype[CreatureSubtype["Monkey"] = 128] = "Monkey";
    CreatureSubtype[CreatureSubtype["Moonfolk"] = 129] = "Moonfolk";
    CreatureSubtype[CreatureSubtype["Mutant"] = 130] = "Mutant";
    CreatureSubtype[CreatureSubtype["Myr"] = 131] = "Myr";
    CreatureSubtype[CreatureSubtype["Mystic"] = 132] = "Mystic";
    CreatureSubtype[CreatureSubtype["Naga"] = 133] = "Naga";
    CreatureSubtype[CreatureSubtype["Nautilus"] = 134] = "Nautilus";
    CreatureSubtype[CreatureSubtype["Nephilim"] = 135] = "Nephilim";
    CreatureSubtype[CreatureSubtype["Nightmare"] = 136] = "Nightmare";
    CreatureSubtype[CreatureSubtype["Nightstalker"] = 137] = "Nightstalker";
    CreatureSubtype[CreatureSubtype["Ninja"] = 138] = "Ninja";
    CreatureSubtype[CreatureSubtype["Noggle"] = 139] = "Noggle";
    CreatureSubtype[CreatureSubtype["Nomad"] = 140] = "Nomad";
    CreatureSubtype[CreatureSubtype["Nymph"] = 141] = "Nymph";
    CreatureSubtype[CreatureSubtype["Octopus"] = 142] = "Octopus";
    CreatureSubtype[CreatureSubtype["Ogre"] = 143] = "Ogre";
    CreatureSubtype[CreatureSubtype["Ooze"] = 144] = "Ooze";
    CreatureSubtype[CreatureSubtype["Orb"] = 145] = "Orb";
    CreatureSubtype[CreatureSubtype["Orc"] = 146] = "Orc";
    CreatureSubtype[CreatureSubtype["Orgg"] = 147] = "Orgg";
    CreatureSubtype[CreatureSubtype["Ouphe"] = 148] = "Ouphe";
    CreatureSubtype[CreatureSubtype["Ox"] = 149] = "Ox";
    CreatureSubtype[CreatureSubtype["Oyster"] = 150] = "Oyster";
    CreatureSubtype[CreatureSubtype["Pegasus"] = 151] = "Pegasus";
    CreatureSubtype[CreatureSubtype["Pentavite"] = 152] = "Pentavite";
    CreatureSubtype[CreatureSubtype["Pest"] = 153] = "Pest";
    CreatureSubtype[CreatureSubtype["Phelddagrif"] = 154] = "Phelddagrif";
    CreatureSubtype[CreatureSubtype["Phoenix"] = 155] = "Phoenix";
    CreatureSubtype[CreatureSubtype["Pilot"] = 156] = "Pilot";
    CreatureSubtype[CreatureSubtype["Pincher"] = 157] = "Pincher";
    CreatureSubtype[CreatureSubtype["Pirate"] = 158] = "Pirate";
    CreatureSubtype[CreatureSubtype["Plant"] = 159] = "Plant";
    CreatureSubtype[CreatureSubtype["Praetor"] = 160] = "Praetor";
    CreatureSubtype[CreatureSubtype["Prism"] = 161] = "Prism";
    CreatureSubtype[CreatureSubtype["Processor"] = 162] = "Processor";
    CreatureSubtype[CreatureSubtype["Rabbit"] = 163] = "Rabbit";
    CreatureSubtype[CreatureSubtype["Rat"] = 164] = "Rat";
    CreatureSubtype[CreatureSubtype["Rebel"] = 165] = "Rebel";
    CreatureSubtype[CreatureSubtype["Reflection"] = 166] = "Reflection";
    CreatureSubtype[CreatureSubtype["Rhino"] = 167] = "Rhino";
    CreatureSubtype[CreatureSubtype["Rigger"] = 168] = "Rigger";
    CreatureSubtype[CreatureSubtype["Rogue"] = 169] = "Rogue";
    CreatureSubtype[CreatureSubtype["Sable"] = 170] = "Sable";
    CreatureSubtype[CreatureSubtype["Salamander"] = 171] = "Salamander";
    CreatureSubtype[CreatureSubtype["Samurai"] = 172] = "Samurai";
    CreatureSubtype[CreatureSubtype["Sand"] = 173] = "Sand";
    CreatureSubtype[CreatureSubtype["Saproling"] = 174] = "Saproling";
    CreatureSubtype[CreatureSubtype["Satyr"] = 175] = "Satyr";
    CreatureSubtype[CreatureSubtype["Scarecrow"] = 176] = "Scarecrow";
    CreatureSubtype[CreatureSubtype["Scion"] = 177] = "Scion";
    CreatureSubtype[CreatureSubtype["Scorpion"] = 178] = "Scorpion";
    CreatureSubtype[CreatureSubtype["Scout"] = 179] = "Scout";
    CreatureSubtype[CreatureSubtype["Serf"] = 180] = "Serf";
    CreatureSubtype[CreatureSubtype["Serpent"] = 181] = "Serpent";
    CreatureSubtype[CreatureSubtype["Servo"] = 182] = "Servo";
    CreatureSubtype[CreatureSubtype["Shade"] = 183] = "Shade";
    CreatureSubtype[CreatureSubtype["Shaman"] = 184] = "Shaman";
    CreatureSubtype[CreatureSubtype["Shapeshifter"] = 185] = "Shapeshifter";
    CreatureSubtype[CreatureSubtype["Sheep"] = 186] = "Sheep";
    CreatureSubtype[CreatureSubtype["Siren"] = 187] = "Siren";
    CreatureSubtype[CreatureSubtype["Skeleton"] = 188] = "Skeleton";
    CreatureSubtype[CreatureSubtype["Slith"] = 189] = "Slith";
    CreatureSubtype[CreatureSubtype["Sliver"] = 190] = "Sliver";
    CreatureSubtype[CreatureSubtype["Slug"] = 191] = "Slug";
    CreatureSubtype[CreatureSubtype["Snake"] = 192] = "Snake";
    CreatureSubtype[CreatureSubtype["Soldier"] = 193] = "Soldier";
    CreatureSubtype[CreatureSubtype["Soltari"] = 194] = "Soltari";
    CreatureSubtype[CreatureSubtype["Spawn"] = 195] = "Spawn";
    CreatureSubtype[CreatureSubtype["Specter"] = 196] = "Specter";
    CreatureSubtype[CreatureSubtype["Spellshaper"] = 197] = "Spellshaper";
    CreatureSubtype[CreatureSubtype["Sphinx"] = 198] = "Sphinx";
    CreatureSubtype[CreatureSubtype["Spider"] = 199] = "Spider";
    CreatureSubtype[CreatureSubtype["Spike"] = 200] = "Spike";
    CreatureSubtype[CreatureSubtype["Spirit"] = 201] = "Spirit";
    CreatureSubtype[CreatureSubtype["Splinter"] = 202] = "Splinter";
    CreatureSubtype[CreatureSubtype["Sponge"] = 203] = "Sponge";
    CreatureSubtype[CreatureSubtype["Squid"] = 204] = "Squid";
    CreatureSubtype[CreatureSubtype["Squirrel"] = 205] = "Squirrel";
    CreatureSubtype[CreatureSubtype["Starfish"] = 206] = "Starfish";
    CreatureSubtype[CreatureSubtype["Surrakar"] = 207] = "Surrakar";
    CreatureSubtype[CreatureSubtype["Survivor"] = 208] = "Survivor";
    CreatureSubtype[CreatureSubtype["Tetravite"] = 209] = "Tetravite";
    CreatureSubtype[CreatureSubtype["Thalakos"] = 210] = "Thalakos";
    CreatureSubtype[CreatureSubtype["Thopter"] = 211] = "Thopter";
    CreatureSubtype[CreatureSubtype["Thrull"] = 212] = "Thrull";
    CreatureSubtype[CreatureSubtype["Treefolk"] = 213] = "Treefolk";
    CreatureSubtype[CreatureSubtype["Trilobite"] = 214] = "Trilobite";
    CreatureSubtype[CreatureSubtype["Triskelavite"] = 215] = "Triskelavite";
    CreatureSubtype[CreatureSubtype["Troll"] = 216] = "Troll";
    CreatureSubtype[CreatureSubtype["Turtle"] = 217] = "Turtle";
    CreatureSubtype[CreatureSubtype["Unicorn"] = 218] = "Unicorn";
    CreatureSubtype[CreatureSubtype["Vampire"] = 219] = "Vampire";
    CreatureSubtype[CreatureSubtype["Vedalken"] = 220] = "Vedalken";
    CreatureSubtype[CreatureSubtype["Viashino"] = 221] = "Viashino";
    CreatureSubtype[CreatureSubtype["Volver"] = 222] = "Volver";
    CreatureSubtype[CreatureSubtype["Wall"] = 223] = "Wall";
    CreatureSubtype[CreatureSubtype["Warrior"] = 224] = "Warrior";
    CreatureSubtype[CreatureSubtype["Weird"] = 225] = "Weird";
    CreatureSubtype[CreatureSubtype["Werewolf"] = 226] = "Werewolf";
    CreatureSubtype[CreatureSubtype["Whale"] = 227] = "Whale";
    CreatureSubtype[CreatureSubtype["Wizard"] = 228] = "Wizard";
    CreatureSubtype[CreatureSubtype["Wolf"] = 229] = "Wolf";
    CreatureSubtype[CreatureSubtype["Wolverine"] = 230] = "Wolverine";
    CreatureSubtype[CreatureSubtype["Wombat"] = 231] = "Wombat";
    CreatureSubtype[CreatureSubtype["Worm"] = 232] = "Worm";
    CreatureSubtype[CreatureSubtype["Wraith"] = 233] = "Wraith";
    CreatureSubtype[CreatureSubtype["Wurm"] = 234] = "Wurm";
    CreatureSubtype[CreatureSubtype["Yeti"] = 235] = "Yeti";
    CreatureSubtype[CreatureSubtype["Zombie"] = 236] = "Zombie";
...
class Permanent {
    ...
    cssColor() {
        return Utilities_1.getCssColor(this.color);
    }
    ...
    describeColors() {
        ...
        for (let clr of this.color) {
            scolors.push(Typeline_1.Color[clr].toLowerCase());
        }
        return Utilities_1.capitalizeFirstLetter(Utilities_1.joinList(scolors));
    }
    createdLinkedCopy(map) {
        let linkedCopy = map.getCopiedPermanent(this);
        /*// Permanent features
    originalCard: Card;
    ...
    assumeCharacteristicsOfOriginal(map) {
        ...
        this.color = Utilities_1.shallowCopy(original.color);
...
class Effect {
    constructor() {
        // Permanent features
        this.acquisition = new Acquisition_1.Acquisition();
        this.modification = new Modification_1.Modification();
    }
    blankTransientFields() {
        this.acquisitionResults = null;
        this.lastAppliedInLayer = Layer_1.Layer.L0_NoLayer;
    ...
    copy() {
        ...
        ff.dependsOn = Utilities_1.shallowCopy(this.dependsOn);
    ...
    toString() {
        ...
        const mainPart = Utilities_1.capitalizeFirstLetter(this.acquisition.toString()) + " " + this.modification.toString(this.acquisition.multipleTargets);
    ...
    isCharacteristicDefiningAbility() {
        ...
        for (let modif of this.modification.parts) {
            if (modif instanceof Modifications_1.SetColorToModification ||
                modif instanceof Modifications_1.SetSubtypeModification ||
                modif instanceof Modifications_1.SetPowerToughnessModification ||
                modif instanceof Modifications_1.ChangelingModification) {
        ...
        let abilityThatGeneratesThis = null;
...
class StateCheck {
    ...
    constructor(field = undefined, effects = undefined) {
    ...
    perform(battlefield) {
        ...
        this.applyLayer(Layer_1.Layer.L1_Copy);
        this.applyLayer(Layer_1.Layer.L2_Control);
        this.applyLayer(Layer_1.Layer.L3_Text);
        this.applyLayer(Layer_1.Layer.L4_Type);
        this.applyLayer(Layer_1.Layer.L5_Color);
        this.applyLayer(Layer_1.Layer.L6_Abilities);
        this.applyLayer(Layer_1.Layer.L7a_PnTCharacteristicDefining);
        this.applyLayer(Layer_1.Layer.L7b_PnTSetSpecificValue);
        this.applyLayer(Layer_1.Layer.L7c_PnTModifications);
        for (let perm of battlefield) {
        ...
        this.applyLayer(Layer_1.Layer.L7e_PnTSwitch);
    ...
    getNextApplicableEffectForLayer(layer) {
        ...
        return DependencySort_1.DependencySort.determineEffectToApply(ffs, this, layer);
    }
    ...
    applyLayer(layer) {
        while (true) {
            let effect = this.getNextApplicableEffectForLayer(layer);
            if (effect) {
    ...
    static layerToString(layer) {
        switch (layer) {
            case Layer_1.Layer.L0_NoLayer:
                return "0";
            case Layer_1.Layer.L1_Copy:
                return "1 (copy)";
            case Layer_1.Layer.L2_Control:
                return "2 (control)";
            case Layer_1.Layer.L3_Text:
                return "3 (text)";
            case Layer_1.Layer.L4_Type:
                return "4 (type)";
            case Layer_1.Layer.L5_Color:
                return "5 (color)";
            case Layer_1.Layer.L6_Abilities:
                return "6 (ability)";
            case Layer_1.Layer.L7a_PnTCharacteristicDefining:
                return "7a (CDA)";
            case Layer_1.Layer.L7b_PnTSetSpecificValue:
                return "7b (set)";
            case Layer_1.Layer.L7c_PnTModifications:
                return "7c (modify)";
            case Layer_1.Layer.L7d_PnTCounters:
                return "7d (counters)";
            case Layer_1.Layer.L7e_PnTSwitch:
                return "7e (switch)";
            default:
                return "UNKNOWN";
        }
...
(function (CardCreator) {
    function parse(script) {
        ...
        let c = new Card_1.Card();
        c.name = nameLine;
        c.color = [];
        c.typeline = new Typeline_1.Typeline();
        c.power = 0;
        c.toughness = 0;
        for (let w of rulesLine.split(' ')) {
            if (Typeline_1.stringToType(w) != null) {
                c.typeline.types.push(Typeline_1.stringToType(w));
            }
            if (Typeline_1.stringToColor(w) != null) {
                c.color.push(Typeline_1.stringToColor(w));
            }
        ...
        if (c.typeline.creatureSubtypes.length > 0 && !c.typeline.types.includes(Typeline_1.Type.Creature)) {
            c.typeline.types.push(Typeline_1.Type.Creature);
        }
        return c;
    }
    CardCreator.parse = parse;
})(CardCreator = exports.CardCreator || (exports.CardCreator = {}));
...
class Ability {
    ...
    toCapitalizedString() {
        return Utilities_1.capitalizeFirstLetter(this.toString());
    }
    toString() {
        if (this.primitiveName != null) {
            ...
            return "Protection from " + Typeline_1.Color[this.protectionFrom].toLowerCase();
        }
    ...
    copyAndInitialize(target) {
        ...
        ab.effect.lastAppliedInLayer = Layer_1.Layer.L0_NoLayer;
...
class SingleAcquisition {
    ...
    getAcquiredObjects(battlefield, source) {
...
exports.SingleAcquisition = SingleAcquisition;
class AcquisitionCondition {
    constructor() {
        this.mustBeThisColor = null;
        this.mustBeThisType = null;
        this.mustBeThisSubtype = null;
        this.suppressTypePlural = false;
        this.mustBeControlledByYou = false;
        this.mustBeControlledByOpponent = false;
        this.nonself = false;
    }
    negate() {
    ...
    toString() {
        if (this.mustBeThisColor != null) {
            return Typeline_1.Color[this.mustBeThisColor].toLowerCase();
        }
        if (this.mustBeThisType != null) {
            return Typeline_1.Type[this.mustBeThisType].toLowerCase() + (this.suppressTypePlural ? "" : "s");
        }
        if (this.mustBeThisSubtype != null) {
            return CreatureSubtype_1.CreatureSubtype[this.mustBeThisSubtype].toLowerCase() + (this.suppressTypePlural ? "" : " creatures");
        }
    ...
    satisfiedBy(target, source, battlefield) {
        if (this.mustBeThisColor != null) {
    ...
    static subtype(theType) {
        let ac = new AcquisitionCondition();
        ac.mustBeThisSubtype = theType;
        return ac;
    }
    static controller(you) {
        let ac = new AcquisitionCondition();
        if (you)
            ac.mustBeControlledByYou = true;
        else
            ac.mustBeControlledByOpponent = true;
        return ac;
    }
    static nonself() {
        let ac = new AcquisitionCondition();
...
exports.AcquisitionCondition = AcquisitionCondition;
class NegatedAcquisitionCondition extends AcquisitionCondition {
...
exports.NegatedAcquisitionCondition = NegatedAcquisitionCondition;
class ComplexAcquisition extends SingleAcquisition {
    ...
    getAcquiredObjects(battlefield, source) {
        let filtered = Utilities_1.shallowCopy(battlefield);
...
exports.ComplexAcquisition = ComplexAcquisition;
class Acquisition {
    constructor() {
    ...
    getAcquiredObjects(battlefield, source) {
        ...
        objs = Utilities_1.removeDuplicates(objs);
        return objs;
    }
}
...
angular.module('PrimaryApp', [])
    ...
    $scope.abilityCreatorToString = function () {
        ...
        return AbilityCreation_1.parseAsAbility($scope.abilityCreatorScript).toString();
    };
    $scope.abilityCreatorAdd = function () {
        let split = $scope.abilityCreatorScript.split("\n");
        let ab = AbilityCreation_1.parseAsAbility($scope.abilityCreatorScript);
    ...
    function recalculateCardCreatorTempCard() {
        $scope.cardCreatorTempCard = CardCreator_1.CardCreator.parse($scope.cardCreatorScript);
    }
    $scope.drawExampleCard = function (script) {
        $scope.hand.push(SampleLoader_1.SampleLoader.createCard(script));
    };
    ...
    $scope.cardCreatorToCard = function () {
    ...
    $scope.cardCreatorCreate = function () {
        ...
        let recipe = new SampleLoader_1.CardRecipe(name, card, []);
        $scope.hand.push(SampleLoader_1.SampleLoader.createCard(recipe));
    };
    $scope.drawArtifact = function () {
        $scope.hand.push(SampleLoader_1.SampleLoader.createCard(Recipes_1.Recipes.Thing));
        reevaluateValues();
    };
    $scope.drawBear = function () {
        $scope.hand.push(SampleLoader_1.SampleLoader.createCard(Recipes_1.Recipes.RuneclawBear));
        reevaluateValues();
    };
    $scope.drawHumility = function () {
        let c = CardCreator_1.CardCreator.parse("Humility\nwhite enchantment");
        c.abilities.push(AbilityCreation_1.parseAsAbility("creature\nget\nsetpt:1/1\nsilence"));
        $scope.hand.push(c);
        reevaluateValues();
    };
    $scope.exampleCards = SampleLoader_1.SampleLoader.getCardRecipes();
    $scope.allScenarios = ScenarioLoader_1.ScenarioLoader.loadAllScenarios();
    ...
    return {
        ...
        link: function (scope, element, attrs) {
            ...
            scope.castSelf = function () {
                removeFromArray(scope.hand, scope.obj);
                scope.battlefield.push(Permanent_1.Permanent.fromCard(scope.obj));
                reevaluateValues();
            };
...
class Card {
    constructor() {
        this.color = [];
        this.typeline = new Typeline_1.Typeline();
        this.abilities = [];
        this.recipe = null;
    }
    cssColor() {
    ...
    asPermanent() {
        return Permanent_1.Permanent.fromCard(this);
    }
}
exports.Card = Card;
class Counter {
...
class ModificationLog {
    constructor() {
        this.ptChanged = false;
        this.typesAdded = [];
        this.strickenAbilities = [];
    }
    addType(aType) {
    ...
    addStrickenAbility(ab) {
        this.strickenAbilities.push(ab);
    }
}
exports.ModificationLog = ModificationLog;
...
class Modification {
    ...
    whatItDoes(battlefield, source, whatItAppliesTo, layer) {
        let dryRun = "";
...
class DependencySort {
   ...
   */
    static determineEffectToApply(effects, stateCheck, layer) {
        if (effects.length == 0) {
            return null;
        }
        if (effects.length == 1) {
    ...
    static createCopiedLinkedGameState(original) {
        ...
        for (let perm of originalField) {
            let copy = new Permanent_1.Permanent();
...
Object.defineProperty(exports, "__esModule", { value: true });
const Scenarios_1 = __webpack_require__(45);
...
exports.Scenarios = ComprehensiveRulesScenarios_1.ComprehensiveRulesScenarios.getThem().concat([
    new Scenario_1.Scenario("Smoke test")
        ...
        it("Trained Armodon is 4/4", () => {
            chai_1.expect(scenario.find("Trained Armodon").power).to.equal(4);
        });
    }),
    new Scenario_1.Scenario("A changeling is every type")
        .addCard(Recipes_1.Recipes.WoodlandChangeling)
        .withVerification((field, scenario) => {
        it("Changeling has at least 50 types", () => {
            chai_1.expect(scenario.find("Woodland Changeling").typeline.creatureSubtypes.length)
                .to.greaterThan(50);
        });
        it("Changeling is a Zubera", () => {
            chai_1.expect(scenario.find("Woodland Changeling").typeline.creatureSubtypes)
                .to.contain(CreatureSubtype_1.CreatureSubtype.Zubera);
        });
    }),
    new Scenario_1.Scenario("Multilayer effects & timestamps")
        ...
        .withVerification((field, scenario) => {
        it("Forest is 3/3", () => {
            chai_1.expect(scenario.find("Forest").power)
                .to.equal(3);
        });
    }),
    new Scenario_1.Scenario("Multilayer effects & timestamps (variant)")
        .addCard({
        name: "Svogthos's Ability",
        card: "enchantment",
        abilities: [
    ...
    new Scenario_1.Scenario("Types and colors not removed by silence")
        .addCard(Recipes_1.Recipes.TrainedArmodon)
        ...
        it("Armodon is a blue artifact.", () => {
            chai_1.expect(scenario.find("Trained Armodon").color).to.contain(Typeline_1.Color.Blue);
            chai_1.expect(scenario.find("Trained Armodon").color).not.to.contain(Typeline_1.Color.Green);
            chai_1.expect(scenario.find("Trained Armodon").typeline.types).to.contain(Typeline_1.Type.Artifact);
            chai_1.expect(scenario.find("Trained Armodon").typeline.types).to.contain(Typeline_1.Type.Creature);
            chai_1.expect(scenario.find("Trained Armodon").typeline.creatureSubtypes).to.contain(CreatureSubtype_1.CreatureSubtype.Elephant);
        });
    ...
    new Scenario_1.Scenario("2x Opalescence, 1x Humility")
        .addCard(Recipes_1.Recipes.Opalescence)
        .addCard(Recipes_1.Recipes.Humility)
        .addCard(Recipes_1.Recipes.Opalescence)
        .withVerification((field, scenario) => {
        it("First Opalescence is 5/5", () => {
            chai_1.expect(field[0].power).to.equal(5);
        });
        it("Humility is 5/5", () => {
            chai_1.expect(field[1].power).to.equal(5);
        });
        it("Second Opalescence is 1/1", () => {
            chai_1.expect(field[2].power).to.equal(1);
        });
        it("Nothing has any abilities", () => {
            chai_1.expect(field[0].abilities).to.be.empty;
            chai_1.expect(field[1].abilities).to.be.empty;
            chai_1.expect(field[2].abilities).to.be.empty;
        });
    ...
    new Scenario_1.Scenario("Dependency loop: Mind Bend")
        ...
        it("Nyx Horse had everything changed to mountainwalk", () => {
            chai_1.expect(s.find("Nyx Horse").abilities[0].toCapitalizedString()).to.equal("Mountainwalk");
...
var pathval = __webpack_require__(47);
...
exports.compareByInspect = __webpack_require__(60);
...
exports.getOwnEnumerableProperties = __webpack_require__(61);

/*!
 * Checks error against a given set of criteria
 */

exports.checkError = __webpack_require__(62);
...
exports.isNaN = __webpack_require__(63);
        ...
        return [
            ...
            new Scenario_1.Scenario("Titania's Song + Opalescence + Mycosynth Lattice")
                ...
                it("Titania's Song retains its ability.", () => {
                    chai_1.expect(scenario.find("Titania's Song").abilities).not.to.be.empty;
                });
                it("Titania's Song is 5/5", () => {
                    chai_1.expect(scenario.find("Titania's Song").power).to.equal(5);
                });
                it("Others are 4/4", () => {
                    chai_1.expect(scenario.find("Opalescence").power).to.equal(4);
                    chai_1.expect(scenario.find("Mycosynth Lattice").power).to.equal(4);
                });
                it("Everything is an artifact creature.", () => {
                    for (let perm of field) {
                        chai_1.expect(perm.typeline.types).to.contain(Typeline_1.Type.Artifact);
                        chai_1.expect(perm.typeline.types).to.contain(Typeline_1.Type.Creature);
                    }
                });
            }),
            new Scenario_1.Scenario("OoO L4: Changeling + Humility")
                .addCard(Recipes_1.Recipes.WoodlandChangeling)
                .addCard(Recipes_1.Recipes.Humility)
                .withVerification((field, scenario) => {
                it("The changeling still has types, but no ability.", () => {
                    ...
                    chai_1.expect(scenario.find("Woodland Changeling").abilities).to.be.empty;
                });
            }),
            new Scenario_1.Scenario("OoO L4: Unnatural Selection + Changeling")
                .addCard({
...
class OrderOfOperationsScenariosL6 {
    static getThem() {
        return [
            new Scenario_1.Scenario("OoO L6: Opalescence + Humility")
                .addCard(Recipes_1.Recipes.Opalescence)
                .addCard(Recipes_1.Recipes.Humility)
                .withVerification((f, s) => {
                it("We're all 1/1's.", () => {
                    chai_1.expect(f[1].power).to.equal(1);
                });
            }),
            new Scenario_1.Scenario("OoO L6: Empty-Shrine Kannushi")
                .addCard({
                ...
                it("Kannushi has protection from blue and not white", () => {
                    chai_1.expect(f[0].abilities.length).to.equal(2);
                    chai_1.expect(f[0].abilities[1].protectionFrom).to.equal(Typeline_1.Color.Blue);
                });
            }),
            new Scenario_1.Scenario("OoO L6: Helm of Kaldra + Ovinize")
                .addCard(Recipes_1.Recipes.TrainedArmodon)
                .addCard({
                ...
                it("Armodon has one set of extra abilities", () => {
                    chai_1.expect(f[0].abilities.length).to.equal(3);
                    chai_1.expect(f[0].power).to.equal(0);
                    chai_1.expect(f[0].toughness).to.equal(1);
                });
            }),
            new Scenario_1.Scenario("OoO L6: Gooey slimy fake Faerie")
                .addCard({
                name: "Spitting Slug",
                card: "green Ooze 1/1",
                abilities: []
                ...
                it("The creature has shroud.", () => {
                    chai_1.expect(f[0].abilities[0].primitiveName.toLowerCase()).to.equal("shroud");
                });
            })
        ];
    }
}
exports.OrderOfOperationsScenariosL6 = OrderOfOperationsScenariosL6;
...
class ComprehensiveRulesScenarios {
    static getThem() {
        return [
            new Scenario_1.Scenario("613.3e1")
                .addCard({
                name: "Spider",
                ...
                .withVerification((f, s) => {
                it("Spider is 4/6", () => {
                    chai_1.expect(f[0].power).to.equal(4);
                    chai_1.expect(f[0].toughness).to.equal(6);
                });
            }),
            new Scenario_1.Scenario("613.3e2")
                .addCard(new SampleLoader_1.CardRecipe("Spider", "1/3 green Spider creature", [["this", "switch"]]))
                .addCard(new SampleLoader_1.CardRecipe("Defensive Booster", "artifact", [["creatures", "get", "+0/+1"]]))
                .withVerification((f, s) => {
                it("Spider is 4/1.", () => {
                    chai_1.expect(f[0].getPT()).eql([4, 1]);
                });
            }),
            new Scenario_1.Scenario("613.3e3")
                .addCard(new SampleLoader_1.CardRecipe("Spider", "1/3 green Spider creature", []))
                .addCard(new SampleLoader_1.CardRecipe("Defensive Booster", "artifact", [["creatures", "get", "+0/+1"]]))
                .addCard(new SampleLoader_1.CardRecipe("Switcher", "artifact", [["creatures", "switch"]]))
                .addCard(new SampleLoader_1.CardRecipe("Switcher", "artifact", [["creatures", "switch"]]))
                .withVerification((f, s) => {
                it("Spider is 1/4.", () => {
                    chai_1.expect(f[0].getPT()).eql([1, 4]);
                });
            }),
            new Scenario_1.Scenario("613.8e1")
                .addCard(Recipes_1.Recipes.RuneclawBear)
                .addCard(new SampleLoader_1.CardRecipe("Thing", "artifact", [["Bear", "flying"]]))
                .addCard(new SampleLoader_1.CardRecipe("Thing", "artifact", [["Bear", "loseprimitive:flying"]]))
                .withVerification((f, s) => {
                it("Bear has no abilities.", () => {
                    chai_1.expect(f[0].abilities.length).to.equal(0);
                });
            }),
            new Scenario_1.Scenario("613.8e2")
                .addCard(Recipes_1.Recipes.RuneclawBear)
                .addCard(Recipes_1.Recipes.HonorOfThePure)
                .addCard(new SampleLoader_1.CardRecipe("Whiter", "artifact", [["creatures", "setcolor:white"]]))
                .withVerification((f, s) => {
                it("The Bear is 3/3.", () => {
                    chai_1.expect(f[0].getPT()).to.eql([3, 3]);
                });
            }),
            new Scenario_1.Scenario("613.4e1")
                .addCard(Recipes_1.Recipes.HonorOfThePure)
                .addCard(Recipes_1.Recipes.RuneclawBear)
                .addCard(new SampleLoader_1.CardRecipe("Whiter", "artifact", [["creatures", "setcolor:white"]]))
                .addCard(new SampleLoader_1.CardRecipe("Redder", "artifact", [["creatures", "setcolor:red"]]))
                .withVerification((f, s) => {
                it("It's only 2/2.", () => {
                    chai_1.expect(f[1].getPT()).eql([2, 2]);
                });
            }),
            new Scenario_1.Scenario("613.4e2")
                .addCard(Recipes_1.Recipes.RuneclawBear)
                ...
                .withVerification((f, s) => {
                it("The Bear is 4/7", () => {
                    chai_1.expect(f[0].getPT()).eql([4, 7]);
                });
            }),
            new Scenario_1.Scenario("613.5e1")
                .addCard(new SampleLoader_1.CardRecipe("Wild Mongrel", "2/2 green creature", [["this", "gets", "+1/+1", "setcolor:blue"]]))
                .withVerification((f, s) => {
                it("It's a 3/3 blue.", () => {
                    chai_1.expect(f[0].getPT()).eql([3, 3]);
                    chai_1.expect(f[0].color).eql([Typeline_1.Color.Blue]);
                });
            }),
            new Scenario_1.Scenario("613.5e2")
                .addCard(Recipes_1.Recipes.RuneclawBear)
                .addCard(new SampleLoader_1.CardRecipe("Act of Treason", "red enchantment", [["bear", "gets", "gainscontrol:2", "haste"]]))
                .withVerification((f, s) => {
                it("Your opponent has the bear and it has haste.", () => {
                    chai_1.expect(f[0].abilities[0].primitiveName.toLowerCase()).equal("haste");
                    chai_1.expect(f[0].controlledByOpponent).to.be.true;
                });
            }),
            new Scenario_1.Scenario("613.5e3")
                .addCard(Recipes_1.Recipes.Thing)
                .addCard(new SampleLoader_1.CardRecipe("Little March", "blue enchantment", [["noncreature artifact", "setpt:2/2", "addtype:creature"]]))
                .withVerification((f, s) => {
                it("It's a 2/2 artifact creature.", () => {
                    chai_1.expect(f[0].getPT()).eql([2, 2]);
                    chai_1.expect(f[0].typeline.types).eql([Typeline_1.Type.Artifact, Typeline_1.Type.Creature]);
                });
            }),
            new Scenario_1.Scenario("613.5e4")
                .addCard({
    ...
    static artifact(...abilityParts) {
        return new SampleLoader_1.CardRecipe("Thing", "artifact", [abilityParts]);
    }
}
